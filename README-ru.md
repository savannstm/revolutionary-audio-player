...
- [x] Оптимизированная обработка аудио любой частоты дискретизации (вплоть до 2\*\*31), до 255 каналов.
- [x] Одинаковые внешний вид и почти те же возможности на **любой** платформе.
...
- Создать производительный аудиоплеер с чистой базой кода.
- Вывести пользовательский опыт и удобство на первый план.
- Быть лучшим потребительским аудио плеером на рынке (потребительским относительного любого бреда, которого хотят аудиофилы от своих аудиоплееров).

### Чего мы не пытаемся достичь

- Быть конвертатором аудиоформатов.
- Быть чем-либо кроме аудиоплеера для проигрывания локальных файлов.
- Поддерживать всё и вся.
